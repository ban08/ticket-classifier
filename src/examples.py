...
EXAMPLES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "ticket_subject": "Configurar permissoes no CRM",
        "ticket_description": "Precisamos ajustar o perfil e role do utilizador para editar clientes no CRM.",
        "client_sector": "packaging",
        "urgency_signals": "sem urgencia; novo utilizador",
        "previous_classification": "client_misunderstanding / medium / support_level_1",
        "preferred_resolver": "Rui Costa",
        "expected": {"ticket_type": "configuration_request", "priority": "low", "module": "user_permissions"},
    },
    {
        ...
        "client_sector": "packaging",
        "urgency_signals": "afeta uma equipa",
        "previous_classification": "",
        "preferred_resolver": "",
        "expected": {"ticket_type": "data_issue", "priority": "medium", "module": "stock"},
    },
    {
        ...
        "previous_classification": "",
        "preferred_resolver": "",
        "expected": {"ticket_type": "infrastructure_problem", "priority": "high", "module": "general"},
    },
    {
